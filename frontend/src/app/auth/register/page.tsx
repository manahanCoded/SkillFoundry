            ...
            <div className="px-12 py-8 bg-zinc-50 flex justify-between flex-col">
              ...
              <div className="flex justify-between items-center  ">
                ...
                >
                  ...
                  <p className="group-hover:border-b group-hover:text-red-600 border-red-600 transition">
                    Go back
                  </p>
                </Link>
                <Link
                  href="/auth/login"
                  className="w-28 p-1  bg-gray-200 hover:rounded hover:text-white hover:bg-red-600 transition text-center"
                >
                  Login
                </Link>
              </div>
